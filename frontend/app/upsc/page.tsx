    ...
    <div className="mt-3 rounded-lg border border-amber-500/15 bg-amber-500/5 overflow-hidden">
      ...
      {expanded && (
        <div className="px-3 pb-3 space-y-3 text-xs">
          {/* Prelims + Mains stacked on mobile, side-by-side on sm+ */}
  ...
  return (
    ...
    >
      <div className="p-3.5 sm:p-5">
        ...
        {/* GS Paper + Subtopic badges — scrollable on mobile if overflow */}
        ...
        {/* Priority badge + source count — wrap on mobile */}
        ...
        {/* Expand for exam playbook — better touch target */}
        {story.exam_playbook && (
          <>
            <button
              onClick={() => setExpanded(!expanded)}
...
function GSSection({
  ...
  return (
    ...
    >
      ...
      {/* Stack metrics vertically on mobile, row on sm+ */}
...
export default function UPSCDashboard() {
  ...
  // Filter by search and selected GS paper
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
        {/* Hero — stack on mobile, row on sm+ */}
        ...
        {/* Average relevance bar + refresh — wrap on mobile */}
        ...
        {/* Search — full width on mobile, max-w-md on larger */}
        ...
        {/* GS Paper selector — scrollable horizontally on mobile */}
